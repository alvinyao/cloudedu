...
class CustomPaginator(Paginator):
	def __init__(self, object_list, per_page, page_num, orphans=0, allow_empty_first_page=True):
		self.page_num = page_num
		super(CustomPaginator, self).__init__(object_list, per_page, orphans=0, allow_empty_first_page=True)
...
class TableBase(object):
    ...
    def paginate(self, klass=CustomPaginator, per_page=None, page=1, *args, **kwargs):
        """
        ...
        self.paginator = klass(self.rows, per_page, page_num=page, *args, **kwargs)
